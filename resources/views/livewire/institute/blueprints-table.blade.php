                ...
                @forelse($blueprints as $bp)
                    <tr>
                        ...
                        <td class="px-6 py-3 space-x-3">
                            <a href="{{ route('institute.blueprints.show', $bp) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
                            <a href="{{ route('institute.blueprints.edit', $bp) }}" class="text-green-600 hover:text-green-900">Edit</a>
